...
import {RehypePlugin as UnifiedRehypePlugin, PluginType, PluginMetadata} from "src/shared/unified-plugin-system";
...
export class CalloutRenderer extends UnifiedRehypePlugin {
